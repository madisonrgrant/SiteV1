...
import signature from './MG-logo.jpeg'
        ...
        return (
          <div className="header-wrapper" style={{"height": this.state.height}}>
            <div className="header">
                <img src={signature} alt="Madison Grant" height="100" width="auto"/>
                <h6>Junior Web Developer</h6>
            </div>
            <div className="scroll-down-btn">
                <ArrowIcon backgroundColor="indianred" onClick={this.onScrollToIntro.bind(this)}/>
            </div>
